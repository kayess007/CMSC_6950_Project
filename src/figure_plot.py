...
#     print("Generated 4 figures in /figures")
...
# def fig_heatmap_day_vs_month(df, date_col, temp_col, out):
#     df = df.copy()
...
#     fig3(df, date_col, temp_col, out)
#     fig4(df, date_col, temp_col, out)
#     fig_heatmap_day_vs_month(df, date_col, temp_col, out)
...
# def fig_season_scatter(df, date_col, temp_col, out):
#     df = df.copy()
...
#     fig3(df, date_col, temp_col, out)
#     fig4(df, date_col, temp_col, out)
#     fig_season_scatter(df, date_col, temp_col, out)
